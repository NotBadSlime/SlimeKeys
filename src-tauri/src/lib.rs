...
use commands::{
    ...
    play_midi_file_from, set_audio_output_device, set_audition_enabled, set_output_enabled,
    set_passthrough_hotkeys, set_playback_speed, set_playback_tracks, start_live_input,
